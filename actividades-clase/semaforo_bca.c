...
int main()
{
    ...
    entre procesos */
    sem_init(&B, 0, 1); // Como tiene el valor de 1 puede comenzar su ejecución de inmediato
    sem_init(&C, 0, 0); // tanto el semáforo C y A deben esperar hasta que se activen 
    sem_init(&A, 0, 0);
